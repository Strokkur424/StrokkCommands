 ...
 * {@link One} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class OneBrigadier {
  public static final String NAME = "command-with-help";
   ...
   * in {@link One}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final One instance = new One();

    return Commands.literal(NAME)
      .executes(ctx -> {
        instance.defaultExecute(
          ctx.getSource().getSender(),
          Collections.unmodifiableList(Arrays.asList(ctx.getInput().split(" ")))
        );
      ...
      .then(Commands.literal("a")
        ...
        .then(Commands.literal("lot")
          ...
          .then(Commands.literal("of")
            ...
            .then(Commands.literal("literals")
              .executes(ctx -> {
                instance.defaultExecute(
                  ctx.getSource().getSender(),
                  Collections.unmodifiableList(Arrays.asList(ctx.getInput().split(" ")))
              ...
              .then(Commands.literal("so")
                ...
                .then(Commands.literal("yeah")
                  ...
                  .then(Commands.argument("num", IntegerArgumentType.integer())
                    ...
                    .then(Commands.argument("stringArg", StringArgumentType.word())
                      .executes(ctx -> {
                        instance.execute(
                          ctx.getSource().getSender(),
                          IntegerArgumentType.getInteger(ctx, "num"),
                          StringArgumentType.getString(ctx, "stringArg")
                        );
                        return Command.SINGLE_SUCCESS;
                      })
                    )
   ...
   */
  private OneBrigadier() throws IllegalAccessException {
