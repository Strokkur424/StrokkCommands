 ...
 * {@link StaticSubcommandsWithHelp} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class StaticSubcommandsWithHelpBrigadier {
  public static final String NAME = "static-subcommands-with-help";
   ...
   *     StaticSubcommandsWithHelpBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link StaticSubcommandsWithHelp}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final StaticSubcommandsWithHelp instance = new StaticSubcommandsWithHelp();
    final StaticSubcommandsWithHelp.Sub instanceSub = new StaticSubcommandsWithHelp.Sub();
      ...
      .then(Commands.literal("subcommand")
        ...
        .then(Commands.argument("val", IntegerArgumentType.integer())
          .executes(ctx -> {
            instanceSub.runInt(
              ctx.getSource().getSender(),
              IntegerArgumentType.getInteger(ctx, "val")
            );
            return Command.SINGLE_SUCCESS;
          })
        )
   ...
   */
  private StaticSubcommandsWithHelpBrigadier() throws IllegalAccessException {
