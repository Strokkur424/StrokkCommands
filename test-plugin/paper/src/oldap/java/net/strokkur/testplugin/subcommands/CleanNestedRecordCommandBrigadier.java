 ...
 * {@link CleanNestedRecordCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class CleanNestedRecordCommandBrigadier {
  public static final String NAME = "cleannestedrecord";
   ...
   *     CleanNestedRecordCommandBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link CleanNestedRecordCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final CleanNestedRecordCommand instance = new CleanNestedRecordCommand();

    return Commands.literal(NAME)
      .then(Commands.argument("word", StringArgumentType.word())
        .executes(ctx -> {
          final CleanNestedRecordCommand.NestedRecord executorClass = new CleanNestedRecordCommand.NestedRecord(
   ...
   */
  private CleanNestedRecordCommandBrigadier() throws IllegalAccessException {
