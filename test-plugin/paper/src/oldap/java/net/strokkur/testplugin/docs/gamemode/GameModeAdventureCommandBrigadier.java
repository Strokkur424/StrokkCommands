 ...
 * {@link GameModeAdventureCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class GameModeAdventureCommandBrigadier {
   ...
   * in {@link GameModeAdventureCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final GameModeAdventureCommand instance = new GameModeAdventureCommand();
   ...
   */
  private GameModeAdventureCommandBrigadier() throws IllegalAccessException {
