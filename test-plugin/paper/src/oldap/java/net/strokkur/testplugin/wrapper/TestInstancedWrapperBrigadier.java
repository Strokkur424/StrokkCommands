 ...
 * {@link TestInstancedWrapper} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class TestInstancedWrapperBrigadier {
  public static final String NAME = "log-test";
   ...
   *     TestInstancedWrapperBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link TestInstancedWrapper}. You can either retrieve the unregistered node with this method
  ...
  public static LiteralCommandNode<CommandSourceStack> create() {
    ...
    return Commands.literal(NAME)
      ...
      .then(Commands.literal("unset")
        .executes(ctx -> {
          instance.executeUnset(ctx.getSource().getSender());
          return Command.SINGLE_SUCCESS;
        })
      )
      .then(Commands.literal("argument-imports")
        .then(Commands.argument("num", IntegerArgumentType.integer())
          .executes(TestInstancedWrapper.log(ctx -> {
            ...
            return Command.SINGLE_SUCCESS;
          }, getMethodViaReflection(TestInstancedWrapper.class, "executeWithArgs", CommandContext.class, int.class, String[].class)))
        )
      )
   ...
   */
  private TestInstancedWrapperBrigadier() throws IllegalAccessException {
