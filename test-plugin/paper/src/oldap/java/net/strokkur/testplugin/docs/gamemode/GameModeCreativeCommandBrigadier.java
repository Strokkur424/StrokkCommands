 ...
 * {@link GameModeCreativeCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class GameModeCreativeCommandBrigadier {
   ...
   * in {@link GameModeCreativeCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final GameModeCreativeCommand instance = new GameModeCreativeCommand();
   ...
   */
  private GameModeCreativeCommandBrigadier() throws IllegalAccessException {
