 ...
 * {@link LongCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class LongCommandBrigadier {
   ...
   *     LongCommandBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link LongCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final LongCommand instance = new LongCommand();

    return Commands.literal(NAME)
      .then(Commands.literal("is")
   ...
   */
  private LongCommandBrigadier() throws IllegalAccessException {
