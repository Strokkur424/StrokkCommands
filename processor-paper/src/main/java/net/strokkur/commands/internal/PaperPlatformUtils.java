...
class PaperPlatformUtils extends PlatformUtils {
  ...
  @Override
  RequiredCommandArgument constructRequiredCommandArgument(final BrigadierArgumentType type, final String name, final SourceVariable parameter, final SourceClass source) {
