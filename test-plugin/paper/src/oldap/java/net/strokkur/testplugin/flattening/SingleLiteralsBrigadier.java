 ...
 * {@link SingleLiterals} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class SingleLiteralsBrigadier {
  public static final String NAME = "single-literals";
   ...
   *     SingleLiteralsBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link SingleLiterals}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final SingleLiterals instance = new SingleLiterals();
   ...
   */
  private SingleLiteralsBrigadier() throws IllegalAccessException {
