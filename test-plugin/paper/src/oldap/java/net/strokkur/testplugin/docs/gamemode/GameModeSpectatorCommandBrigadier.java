 ...
 * {@link GameModeSpectatorCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class GameModeSpectatorCommandBrigadier {
  public static final String NAME = "gmsp";
   ...
   * in {@link GameModeSpectatorCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final GameModeSpectatorCommand instance = new GameModeSpectatorCommand();
    final GameModePreset instanceGameMode = instance.gameMode;
    ...
    return Commands.literal(NAME)
      ...
      .then(Commands.argument("target", ArgumentTypes.player())
        .executes(ctx -> {
          instanceGameMode.executesTarget(
            ctx.getSource().getSender(),
   ...
   */
  private GameModeSpectatorCommandBrigadier() throws IllegalAccessException {
