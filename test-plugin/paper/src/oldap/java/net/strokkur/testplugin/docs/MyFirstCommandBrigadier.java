 ...
 * {@link MyFirstCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class MyFirstCommandBrigadier {
  public static final String NAME = "firstcommand";
  public static final @Nullable String DESCRIPTION = "My first StrokkCommands-command!";
  public static final List<String> ALIASES = List.of("fc");
   ...
   * in {@link MyFirstCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final MyFirstCommand instance = new MyFirstCommand();
   ...
   */
  private MyFirstCommandBrigadier() throws IllegalAccessException {
