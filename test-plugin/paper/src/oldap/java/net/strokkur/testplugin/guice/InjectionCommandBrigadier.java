 ...
 * {@link InjectionCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class InjectionCommandBrigadier {
  public static final String NAME = "injection-test";
   ...
   *     InjectionCommandBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link InjectionCommand}. You can either retrieve the unregistered node with this method
