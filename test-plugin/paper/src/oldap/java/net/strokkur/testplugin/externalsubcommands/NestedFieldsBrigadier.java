 ...
 * {@link NestedFields} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class NestedFieldsBrigadier {
  public static final String NAME = "nestedfields";
   ...
   *     NestedFieldsBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link NestedFields}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final NestedFields instance = new NestedFields();
    final NestedFields.FirstNesting instanceFirstNesting = new NestedFields.FirstNesting();
    final NestedFields.SecondNesting instanceFirstNestingSecondNesting = new NestedFields.SecondNesting();

    return Commands.literal(NAME)
      .then(Commands.literal("first")
        .then(Commands.literal("second")
          .executes(ctx -> {
            instanceFirstNestingSecondNesting.execute(ctx.getSource().getSender());
   ...
   */
  private NestedFieldsBrigadier() throws IllegalAccessException {
