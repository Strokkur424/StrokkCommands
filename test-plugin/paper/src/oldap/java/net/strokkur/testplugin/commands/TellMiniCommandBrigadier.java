 ...
 * {@link TellMiniCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class TellMiniCommandBrigadier {
  public static final String NAME = "tellmini";
   ...
   * in {@link TellMiniCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final TellMiniCommand instance = new TellMiniCommand();
   ...
   */
  private TellMiniCommandBrigadier() throws IllegalAccessException {
