...
<Aside type="tip">
  ...
  under [strokk-commands-test-plugin/src/main/java/net/strokkur/testplugin/docs/gamemode](https://github.com/Strokkur424/StrokkCommands/tree/main/strokk-commands-test-plugin/src/main/java/net/strokkur/testplugin/docs/gamemode).
</Aside>
