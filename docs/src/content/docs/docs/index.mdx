...
on classes or methods. It is created for the [Paper](https://github.com/PaperMC/Paper) server software, but probably
also works fine on most of its fork, unless they mess with the command system.

StrokkCommands has every single natively available argument type implemented. All you need to is add whichever
type you need to your executor method and StrokkCommands will take care of the rest!
