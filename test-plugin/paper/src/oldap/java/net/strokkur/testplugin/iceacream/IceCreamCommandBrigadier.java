 ...
 * {@link IceCreamCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class IceCreamCommandBrigadier {
  public static final String NAME = "icecream";
   ...
   * in {@link IceCreamCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final IceCreamCommand instance = new IceCreamCommand();

    return Commands.literal(NAME)
      .then(Commands.literal("lick")
        .then(Commands.argument("iceCream", new IceCreamArgument())
          .executes(ctx -> {
            instance.onLick(
              ctx.getSource().getSender(),
              ctx.getArgument("iceCream", IceCreamType.class)
            );
   ...
   */
  private IceCreamCommandBrigadier() throws IllegalAccessException {
