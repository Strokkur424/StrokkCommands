 ...
 * {@link InnerCommandNested} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class InnerCommandNestedBrigadier {
  public static final String NAME = "innercommandnested";
   ...
   *     InnerCommandNestedBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link InnerCommandNested}. You can either retrieve the unregistered node with this method
  ...
  public static LiteralCommandNode<CommandSourceStack> create() {
    ...
    final InnerCommandNested.MyNestedClass instanceNestedMyNestedClass = new InnerCommandNested.MyNestedClass();

    return Commands.literal(NAME)
      .then(Commands.literal("nested")
        .then(Commands.literal("a")
          .executes(ctx -> {
            instanceNestedMyNestedClass.execute(ctx.getSource().getSender());
   ...
   */
  private InnerCommandNestedBrigadier() throws IllegalAccessException {
