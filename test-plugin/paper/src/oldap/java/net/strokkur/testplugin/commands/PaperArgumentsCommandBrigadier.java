 ...
 * {@link PaperArgumentsCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class PaperArgumentsCommandBrigadier {
  public static final String NAME = "paperargs";
   ...
   * in {@link PaperArgumentsCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final PaperArgumentsCommand instance = new PaperArgumentsCommand();

    return Commands.literal(NAME)
      .requires(source -> source.getExecutor() != null)
        ...
        .then(Commands.argument("itemStack", ArgumentTypes.itemStack())
          .executes(ctx -> {
            ...
            instance.executes(
              ...
              executor,
              ctx.getArgument("itemStack", ItemStack.class)
            );
      ...
      .then(Commands.literal("time")
        .then(Commands.argument("time", ArgumentTypes.time())
          .executes(ctx -> {
            if (!(ctx.getSource().getExecutor() instanceof Entity executor)) {
              throw new SimpleCommandExceptionType(MessageComponentSerializer.message().serialize(
                Component.text("This command requires an entity executor!")
              )).create();
            }
   ...
   */
  private PaperArgumentsCommandBrigadier() throws IllegalAccessException {
