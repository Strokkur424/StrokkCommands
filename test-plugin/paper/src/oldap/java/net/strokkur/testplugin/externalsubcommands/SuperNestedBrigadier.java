...
import net.strokkur.testplugin.externalsubcommands.SuperNested.InnerNonStatic;
import net.strokkur.testplugin.externalsubcommands.SuperNested.NestedClass.UltraNested;
 ...
 * {@link SuperNested} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class SuperNestedBrigadier {
  public static final String NAME = "supernested";
   ...
   *     SuperNestedBrigadier.register(commands);
   * }
   * }</pre>
   */
   ...
   * in {@link SuperNested}. You can either retrieve the unregistered node with this method
    ...
    return Commands.literal(NAME)
      .then(Commands.literal("nonstatic")
        .then(Commands.literal("ULTRA-NESTED")
          .executes(ctx -> {
            instanceInnerNonStaticNestedUltraNested.execute(ctx.getSource().getSender());
   ...
   */
  private SuperNestedBrigadier() throws IllegalAccessException {
