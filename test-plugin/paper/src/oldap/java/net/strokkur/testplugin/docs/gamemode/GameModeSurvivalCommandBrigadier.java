 ...
 * {@link GameModeSurvivalCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class GameModeSurvivalCommandBrigadier {
   ...
   * in {@link GameModeSurvivalCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final GameModeSurvivalCommand instance = new GameModeSurvivalCommand();
   ...
   */
  private GameModeSurvivalCommandBrigadier() throws IllegalAccessException {
