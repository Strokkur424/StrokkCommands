 ...
 * {@link LiteralsCommand} using <a href="https://commands.strokkur.net">StrokkCommands</a>.
 *
 ...
 */
@NullMarked
public final class LiteralsCommandBrigadier {
   ...
   * in {@link LiteralsCommand}. You can either retrieve the unregistered node with this method
   * or register it directly with {@link #register(Commands)}.
   */
  public static LiteralCommandNode<CommandSourceStack> create() {
    final LiteralsCommand instance = new LiteralsCommand();

    return Commands.literal(NAME)
      .then(Commands.literal("hey")
        .then(Commands.literal("there,")
          .then(Commands.literal("how")
            .then(Commands.literal("am")
              .then(Commands.literal("I")
                .then(Commands.literal("doing?")
                  .executes(ctx -> {
                    instance.executes(
   ...
   */
  private LiteralsCommandBrigadier() throws IllegalAccessException {
